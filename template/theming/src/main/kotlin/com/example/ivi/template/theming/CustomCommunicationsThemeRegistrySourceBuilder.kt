...
/**
 * The builder builds [CustomCommunicationsThemeRegistrySource].
 *
...
class CustomCommunicationsThemeRegistrySourceBuilder : IviThemeRegistrySourceBuilder {

    override fun build(
        registrySourceContext: IviThemeRegistrySourceContext,
    ): IviThemeRegistrySource =
        CustomCommunicationsThemeRegistrySource(registrySourceContext)
}
