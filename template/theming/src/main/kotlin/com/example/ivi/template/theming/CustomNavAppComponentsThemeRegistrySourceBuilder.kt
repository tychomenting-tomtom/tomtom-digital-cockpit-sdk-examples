...
/**
 * The builder builds [CustomNavAppComponentsThemeRegistrySource].
 *
...
class CustomNavAppComponentsThemeRegistrySourceBuilder : IviThemeRegistrySourceBuilder {

    override fun build(
        registrySourceContext: IviThemeRegistrySourceContext,
    ): IviThemeRegistrySource =
        CustomNavAppComponentsThemeRegistrySource(registrySourceContext)
}
