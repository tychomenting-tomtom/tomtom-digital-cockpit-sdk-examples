...
/**
 * The builder builds [CustomCoreComponentsThemeRegistrySource].
 *
...
class CustomCoreComponentsThemeRegistrySourceBuilder : IviThemeRegistrySourceBuilder {

    override fun build(
        registrySourceContext: IviThemeRegistrySourceContext,
    ): IviThemeRegistrySource =
        CustomCoreComponentsThemeRegistrySource(registrySourceContext)
}
