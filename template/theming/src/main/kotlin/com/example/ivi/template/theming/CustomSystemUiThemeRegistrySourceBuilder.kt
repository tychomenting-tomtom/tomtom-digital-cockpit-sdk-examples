...
/**
 * The builder builds [CustomSystemUiThemeRegistrySource].
 *
...
class CustomSystemUiThemeRegistrySourceBuilder : IviThemeRegistrySourceBuilder {

    override fun build(
        registrySourceContext: IviThemeRegistrySourceContext,
    ): IviThemeRegistrySource =
        CustomSystemUiThemeRegistrySource(registrySourceContext)
}
