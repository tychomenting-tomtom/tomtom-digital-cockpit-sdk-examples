...
/**
 * The builder builds [CustomMediaThemeRegistrySource].
 *
...
class CustomMediaThemeRegistrySourceBuilder : IviThemeRegistrySourceBuilder {

    override fun build(
        registrySourceContext: IviThemeRegistrySourceContext,
    ): IviThemeRegistrySource =
        CustomMediaThemeRegistrySource(registrySourceContext)
}
