...
/**
 * The builder builds [CustomSystemStatusThemeRegistrySource].
 *
...
class CustomSystemStatusThemeRegistrySourceBuilder : IviThemeRegistrySourceBuilder {

    override fun build(
        registrySourceContext: IviThemeRegistrySourceContext,
    ): IviThemeRegistrySource =
        CustomSystemStatusThemeRegistrySource(registrySourceContext)
}
