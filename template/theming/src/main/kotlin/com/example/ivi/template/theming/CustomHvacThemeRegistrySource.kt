...
import com.tomtom.ivi.appsuite.hvac.api.common.attributes.R as RAttr
...
/**
 * The [IviThemeRegistrySource] of custom HVAC theme components.
 *
 * HVAC theme components define the styles specific for TTDC HVAC domain.
 */
@OptIn(IviExperimental::class)
internal class CustomHvacThemeRegistrySource(
    ...
    override suspend fun IviThemeCategorySetConfigurator.applyConfig() {
        /**
         * Extends theme categories with HVAC specific theme styles.
         *
         * Each category is extended similarly as the following:
         * ```kotlin
         * // Configures the color category.
         * configure(colorThemeCategory) {
         *     // To style HVAC color stylable `TtiviHvacThemeCategoryColors`.
         *     toStyle(RAttr.styleable.TtiviHvacThemeCategoryColors) {
         ...
         *                     // Applies `R.style.CustomThemeHvacColorDark`.
         *                     applyStyle(R.style.CustomThemeHvacColorDark)
         *                 // When Light flavor
         *                 CustomColorThemeCategoryStylingFlavor.CUSTOM_LIGHT ->
         *                     // Applies `R.style.CustomThemeHvacColorLight`.
         *                     applyStyle(R.style.CustomThemeHvacColorLight)
         *                 }
         *             }
         *         }
         *     }
