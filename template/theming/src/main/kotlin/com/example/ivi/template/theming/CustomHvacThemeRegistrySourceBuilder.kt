...
/**
 * The builder builds [CustomHvacThemeRegistrySource].
 *
...
class CustomHvacThemeRegistrySourceBuilder : IviThemeRegistrySourceBuilder {

    override fun build(
        registrySourceContext: IviThemeRegistrySourceContext,
    ): IviThemeRegistrySource =
        CustomHvacThemeRegistrySource(registrySourceContext)
}
