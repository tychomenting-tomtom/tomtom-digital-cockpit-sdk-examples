...
// The theming module is `template_theming`.
private val themingModule = ModuleReference(
    groupName = "com.example.ivi",
    moduleName = "template_theming",
    packageName = "com.example.ivi.template.theming"
)
